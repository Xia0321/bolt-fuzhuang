...
export const t: Dict = {
  ...
  order_email_sent: { zh: '订单确认邮件已发送至 {email}。', en: 'A confirmation email has been sent to {email}.', ja: 'ご注文確認メールを {email} にお送りしました。' },
  order_register_hint: {
  ...
  auth_err_ACCOUNT_NOT_CONFIRMED: {
    zh: '账号尚未确认，请点击注册确认邮件中的链接。没有收到可以重新注册一次。',
    en: 'Please confirm your account using the link in the confirmation email. Didn’t get it? Register again to resend.',
    ja: 'アカウントが未確認です。確認メールのリンクをクリックしてください。届いていない場合は再度ご登録ください。',
  },
  ...
  register_check_email: {
    zh: '确认邮件已发送至 {email}，请点击邮件中的链接完成注册。',
    en: 'We’ve sent a confirmation email to {email}. Click the link in it to finish signing up.',
    ja: '{email} に確認メールをお送りしました。メール内のリンクをクリックして登録を完了してください。',
  },
  register_check_email_hint: {
    zh: '没有收到？请检查垃圾邮件，或几分钟后重新注册一次。',
    en: 'Didn’t get it? Check your spam folder, or register again in a few minutes.',
    ja: '届かない場合は迷惑メールフォルダをご確認いただくか、数分後にもう一度ご登録ください。',
  },
  confirm_title: { zh: '确认账号', en: 'Confirm Account', ja: 'アカウント確認' },
  confirm_done: { zh: '账号已确认，现在可以登录了。', en: 'Your account is confirmed. You can sign in now.', ja: 'アカウントが確認されました。ログインできます。' },
  confirm_failed: {
    zh: '确认链接无效或已过期。如果账号已确认，请直接登录；否则请重新注册。',
    en: 'This link is invalid or has expired. If your account is already confirmed, just sign in; otherwise register again.',
    ja: 'リンクが無効か期限切れです。確認済みの場合はログインし、そうでない場合は再度ご登録ください。',
  },
